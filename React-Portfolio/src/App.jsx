  ...
  return (
    ...
    <div className="tentang mt-32 py-10">
      <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-lg">
        <img src={DataImage.HeroImage} alt="Tentang Image" className="w-12 rounded-md mb-10 sm:hidden"/>
        <p className="text-base/loose mb-10">
          Hi, perkenalkan saya Diky Prayoga, 
          seorang Full Stack Web Developer dan Designer untuk UI/UX Design maupun Product Digital, 
      ...
      <div className="tools mt-32">
        ...
        <p className="w-2/5 text-base/loose opacity-50">Berikut adalah beberapa tools yang saya gunakan untuk membuat proyek-proyek saya</p>
